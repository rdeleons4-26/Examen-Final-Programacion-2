...
3. **CRUD de Libros**  
4. **Ingreso/Login**  
5. **Acerca de** (información del alumno y foto)  
...
3. Verificar que el MySQL Connector/J** esté agregado:  
...
- Alumna: Rita Shantal de León  
- GitHub: [https://github.com/rdeleons4-26/Proyecto-Final-Biblioteca](https://github.com/rdeleons4-26/Proyecto-Final-Biblioteca)
